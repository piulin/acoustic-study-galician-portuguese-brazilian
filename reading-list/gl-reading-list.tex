...
\newpage
\begin{itemize}
    \item \textsc{O tamén antigo primeiro-ministro do Perú estaba afastado da vida pública hai varios anos devido ó delicado estado de saúde.}
    \item \textsc{As súas formas podem variar de hervas anuais, bianuais ou perenes, sendo raramente arbustos ou árbores.}
    
    \item \textsc{A influencia gravitacional de Neptuno posúe un importante papel no movimento orbital dos obxectos que se encontram além da súa órbita, no Cinturón de Kuiper, poboado por grandes corpos xeados.}
\end{itemize}
